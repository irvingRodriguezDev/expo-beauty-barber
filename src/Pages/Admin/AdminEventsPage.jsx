  ...
  return (
    <AdminLayout>
      <Box>
              ...
              <Table>
                ...
                <TableBody>
                  {events.map((event) => {
                    const percentage =
                      event.totalSeats > 0
                        ? Math.round((event.soldSeats / event.totalSeats) * 100)
                        : 0;
                    return (
        ...
        {/* Modal / Dialog para Crear Evento */}
        <Dialog
          open={openModal}
        ...
        >
          <Box component='form' onSubmit={handleCreateEvent}>
            <DialogTitle sx={{ fontWeight: "bold", color: "#0F172A" }}>
              Registrar Nueva Expo o Ponencia
            </DialogTitle>
            <DialogContent dividers>
              <Grid container spacing={2} sx={{ mt: 0.5 }}>
                <Grid item xs={12} sm={8}>
                  <TextField
                    fullWidth
                    label='Nombre de la Expo / Ponencia'
                    name='title'
                ...
                <Grid item xs={12} sm={6}>
                  <TextField
                    ...
                    value={formData.slug}
                    onChange={handleInputChange}
                    helperText='Ej: expo-beauty-cdmx-2026'
                    required
                  />
                </Grid>
                ...
                <Grid item xs={12}>
                  <TextField
                    ...
                    onChange={handleInputChange}
                    placeholder='Ej: Centro Citibanamex, Sala B'
                    required
                  />
                </Grid>
                ...
                <Grid item xs={12}>
                  <TextField
                    fullWidth
                    label='URL del Banner Promocional'
                    name='bannerUrl'
                ...
                <Grid item xs={12}>
                  <TextField
                    ...
                    multiline
                    rows={3}
                    label='Descripción / Detalles de la Ponencia'
                    name='description'
